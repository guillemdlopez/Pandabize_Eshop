...
ActiveRecord::Schema.define(version: 2021_03_07_144413) do
  ...
  create_table "customizations", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["bicycle_id"], name: "index_customizations_on_bicycle_id"
  end
  ...
  add_foreign_key "customizations", "bicycles"
  add_foreign_key "orders", "bicycles"
  add_foreign_key "orders", "users"
  add_foreign_key "purchased_customizations", "customizations"
  add_foreign_key "purchased_customizations", "orders"
end
